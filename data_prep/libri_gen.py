...
train_txt = "/speech/Databases/Birdsong/Libri100SpkId/train_split.txt"
test_txt = "/speech/Databases/Birdsong/Libri100SpkId/test_split.txt"
train_ids = []
test_ids = []
...
utt2spk_root = "/speech/Databases/Birdsong/Libri100SpkId/utt2spk"
utt2spk = dict()
...
test_csv.to_csv("/speech/Databases/Birdsong/Libri100SpkId/test_data.csv", index=False)
...
train_csv.to_csv("/speech/Databases/Birdsong/Libri100SpkId/train_data.csv", index=False)